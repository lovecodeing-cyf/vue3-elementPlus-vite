<template>
    <el-form ref="registerFormRef" :model="registerUser" :rules="rules" label-width="120px"
        ...
        <el-form-item label="确认密码" prop="password2">
            <el-input v-model="registerUser.password2" placeholder="请再次输入密码" type="password"></el-input>
        </el-form-item>
